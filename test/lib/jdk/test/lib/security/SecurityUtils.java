...
public final class SecurityUtils {
    ...
    public static final List<String> FIPS_TLS_PROTOCOLS = new ArrayList<>();
    ...
    static {
        ...
        FIPS_TLS_CIPHERSUITES.put("TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256", Arrays.asList("TLSv1.2", "DTLSv1.2"));
        FIPS_TLS_CIPHERSUITES.put("TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384", Arrays.asList("TLSv1.2", "DTLSv1.2"));
        FIPS_TLS_CIPHERSUITES.put("TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384", Arrays.asList("TLSv1.2", "DTLSv1.2"));
        FIPS_TLS_CIPHERSUITES.put("TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256", Arrays.asList("TLSv1.2", "DTLSv1.2"));
        FIPS_TLS_CIPHERSUITES.put("TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256", Arrays.asList("TLSv1.2", "DTLSv1.2"));
    }
    ...
    public static boolean isValidProtocolInFIPS(String protocol) {
        return (protocol != null && FIPS_TLS_PROTOCOLS.contains(protocol));
    }

    public static boolean isValidCipherInFIPS(String cipher) {
        return (cipher != null && FIPS_TLS_CIPHERSUITES.containsKey(cipher));
    }
    ...
    public static void FipsSSLHandshakeException(javax.net.ssl.SSLHandshakeException sslhe, String cipher, String protocol) {
        ...
        if (!isValidProtocolInFIPS(protocol) || !isValidCipherInFIPS(cipher)) {
